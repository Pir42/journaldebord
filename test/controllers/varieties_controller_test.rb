...
class VarietiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create variety" do
    assert_difference('Variety.count') do
      post varieties_url, params: { variety: { name: @variety.name, user_id: @variety.user_id, vegetable_id: @variety.vegetable_id } }
    end
  ...
  test "should update variety" do
    patch variety_url(@variety), params: { variety: { name: @variety.name, user_id: @variety.user_id, vegetable_id: @variety.vegetable_id } }
