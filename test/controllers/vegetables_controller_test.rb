...
class VegetablesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vegetable" do
    assert_difference('Vegetable.count') do
      post vegetables_url, params: { vegetable: { name: @vegetable.name, user_id: @vegetable.user_id } }
    end
  ...
  test "should update vegetable" do
    patch vegetable_url(@vegetable), params: { vegetable: { name: @vegetable.name, user_id: @vegetable.user_id } }
