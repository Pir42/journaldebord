...
class ParcelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create parcel" do
    assert_difference('Parcel.count') do
      post parcels_url, params: { parcel: { idPlace: @parcel.idPlace, name: @parcel.name, user_id: @parcel.user_id } }
    end
  ...
  test "should update parcel" do
    patch parcel_url(@parcel), params: { parcel: { idPlace: @parcel.idPlace, name: @parcel.name, user_id: @parcel.user_id } }
