...
class DirectoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create directory" do
    assert_difference('Directory.count') do
      post directories_url, params: { directory: { address: @directory.address, city: @directory.city, comment: @directory.comment, contract: @directory.contract, first_name: @directory.first_name, last_name: @directory.last_name, phone: @directory.phone, postcode: @directory.postcode } }
    end
  ...
  test "should update directory" do
    patch directory_url(@directory), params: { directory: { address: @directory.address, city: @directory.city, comment: @directory.comment, contract: @directory.contract, first_name: @directory.first_name, last_name: @directory.last_name, phone: @directory.phone, postcode: @directory.postcode } }
